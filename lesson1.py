...
#path = "/home/renjith/datascience/kaggle/input/fastai/dogscats/"
path = "/home/renjith/datascience/kaggle/input/fastai/dogscats/sample/"
...
vgg.fit(batches, val_batches, nb_epoch=1)
test_batches = vgg.get_batches(path+'test1', batch_size=batch_size*2, shuffle=False)
