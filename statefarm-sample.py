...
get_ipython().magic('cd data/state')


# In[ ]:

get_ipython().magic('cd train')


# In[ ]:

get_ipython().magic('mkdir ../sample')
get_ipython().magic('mkdir ../sample/train')
get_ipython().magic('mkdir ../sample/valid')
...
get_ipython().magic('mkdir data/state/results')


# In[8]:

get_ipython().magic('mkdir data/state/sample/test')
